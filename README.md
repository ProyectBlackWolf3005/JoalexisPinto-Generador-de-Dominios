...
- Generación de dominios usando arrays.
- Uso de bucles anidados para crear combinaciones.
- Extensiones como `.com`, `.net`, `.io` y `.es`.
- Inclusión de algunos domain hacks como `.es` y `.io`.
...
- `script.js` → lógica para generar dominios

---

**Autor:** Joalexis Pinto